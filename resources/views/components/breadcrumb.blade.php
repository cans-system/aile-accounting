<div class="py-1 mb-3 border-bottom border-primary fw-bold d-flex">
	<div class="bdcb">{{ $page_current->small_group->big_group->title }}</div>
	<div class="bdcb"><i class="fa-solid fa-angle-right"></i></div>
	<div class="bdcb">{{ $page_current->small_group->title }}</div>
	<div class="bdcb"><i class="fa-solid fa-angle-right"></i></div>
	@foreach ($page_current->small_group->pages as $item)
		@if ($item->id == $page_current->id)
